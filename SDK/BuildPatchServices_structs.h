...
struct FFileManifestData
{
	...
	unsigned char                                      UnknownData_0K5W[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W4DN[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HY9X[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
struct FChunkInfoData
{
	...
	unsigned char                                      UnknownData_J6XE[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QXDR[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
