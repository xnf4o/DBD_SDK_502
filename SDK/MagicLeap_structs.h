...
{
	unsigned char                                      UnknownData_ZCYW[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OR3G[0xF];                                     // 0x0031(0x000F) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_C1SA[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NG6H[0x28];                                    // 0x0020(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M7SF[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FMagicLeapMeshBlockRequest
{
	...
	unsigned char                                      UnknownData_GQJG[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMagicLeapMeshBlockInfo
{
	...
	unsigned char                                      UnknownData_JEYM[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YBSS[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
struct FMagicLeapRaycastHitResult
{
	...
	unsigned char                                      UnknownData_CGMK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapRaycastQueryParams
{
	...
	unsigned char                                      UnknownData_9NW4[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapHeadTrackingState
{
	...
	unsigned char                                      UnknownData_OM8D[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
