...
struct FLiveLinkSourceBufferManagementSettings
{
	...
	unsigned char                                      UnknownData_7B4C[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PTC4[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S23Z[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BKF6[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WDA6[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_A1QD[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1PQP[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZTBH[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PPCH[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BIC2[0x160];                                   // 0x0000(0x0160) MISSED OFFSET (PADDING)
...
struct FSubjectMetadata
{
	...
	unsigned char                                      UnknownData_B6CY[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
struct FLiveLinkBaseFrameData
{
	...
	unsigned char                                      UnknownData_WQCE[0x20];                                    // 0x0080(0x0020) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraStaticData : public FLiveLinkTransformStaticData
{
	...
	unsigned char                                      UnknownData_BTIZ[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraFrameData : public FLiveLinkTransformFrameData
{
	...
	unsigned char                                      UnknownData_DRAV[0xB];                                     // 0x00E5(0x000B) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_TGDQ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkLightStaticData : public FLiveLinkTransformStaticData
{
	...
	unsigned char                                      UnknownData_A9ZL[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FLiveLinkLightFrameData : public FLiveLinkTransformFrameData
{
	...
	unsigned char                                      UnknownData_F0LR[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (PADDING)
...
struct FLiveLinkLightBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_NMEH[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkSubjectPreset
{
	...
	unsigned char                                      UnknownData_XP6J[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U9BA[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FLiveLinkSubjectRepresentation
{
	...
	unsigned char                                      UnknownData_UC5J[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkInterpolationSettings
{
	...
	unsigned char                                      UnknownData_TPHK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkTransformBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_1OJP[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
