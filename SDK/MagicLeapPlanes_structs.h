...
struct FMagicLeapPlaneResult
{
	...
	unsigned char                                      UnknownData_F8X5[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapPlanesQuery
{
	...
	unsigned char                                      UnknownData_ZM2Z[0xE];                                     // 0x0052(0x000E) MISSED OFFSET (PADDING)
